...
class RequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        memc = memcache.Client(['127.0.0.1:11311'])
...
if __name__ == "__main__":
    ...
    proc = subprocess.Popen(["memcached", "-p", str(11311), "-m", "512"])
    ...
    try:
        ...
        server = ForkingHTTPServer((HOST, PORT), RequestHandler)

        print "Forking HTTP server started on %s:%d" % (HOST, PORT)
